...
set output "temperatureprofile.tex"
...
plot 'WD-profile-M1.08-N108.dat' u 1:(log10($3)) w l ls 12 lw 4,\
     '../CaseA-profile-N116.dat' u 1:(log10($3)) w l lc rgb '#a2142f' dt 3 lw 4
