...
plot 'helium.dat' u 1:($2) w l ls 1 lw 2,\
     'helium.dat' u 1:($11) w l ls 2 lw 2,\
     'helium.dat' u 1:($21) w l ls 3 lw 2,\
     'helium.dat' u 1:($31) w l ls 4 lw 2,\
     'helium.dat' u 1:($41) w l ls 5 lw 2,\
     'helium.dat' u 1:($51) w l ls 6 lw 2,\
     'helium.dat' u 1:($61) w l ls 7 lw 2,\
     'helium.dat' u 1:($71) w l ls 8 lw 2,\
     'helium.dat' u 1:($81) w l ls 9 lw 2,\
     'helium.dat' u 1:($91) w l ls 10 lw 2,\
     'helium.dat' u 1:($101) w l ls 11 lw 2,\
     'helium.dat' u 1:($111) w l ls 12 lw 2,\
     'helium.dat' u 1:($121) w l ls 12 lw 2
